...
// vida:inicio
import { initPerfil } from "./vida-perfil.js?v=133";
import { initVida } from "./vida.js?v=133";
import { mountVidaHoy, renderVidaHoy } from "./views/vida-hoy.js?v=133";
import { mountVidaEntreno, renderVidaEntreno } from "./views/vida-entreno.js?v=133";
import { mountVidaProgreso, renderVidaProgreso } from "./views/vida-progreso.js?v=133";
import { mountVidaCartera, renderVidaCartera } from "./views/vida-cartera.js?v=133";
import { mountVidaMenu, renderVidaMenu } from "./views/vida-menu.js?v=133";
import { mountVidaCompras, renderVidaCompras } from "./views/vida-compras.js?v=133";
import { mountVidaCiclo, renderVidaCiclo } from "./views/vida-ciclo.js?v=133";
import { mountVidaOficina, renderVidaOficina } from "./views/vida-oficina.js?v=133";
import { mountVidaAgenda, renderVidaAgenda } from "./views/vida-agenda.js?v=133";
// vida:fin
