...
import { addCuenta, addCategoria, addSuscripcion, addMetaAhorro, updateCuenta, updateMovimiento, fechaISO } from "./db.js?v=122";
import { crudos, esGaby } from "./vida-perfil.js?v=122";
