...
import { auth } from "../firebase-init.js?v=90";
import { state } from "../store.js?v=90";
import { exportarDatos, importarDatos } from "../backup.js?v=90";
import { bloquearScrollFondo, desbloquearScrollFondo } from "../scroll-lock.js?v=90";
import { montarSelectorTemas } from "../tema.js?v=90";
