...
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=105";
import { seedInitialData } from "../seed.js?v=105";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=105";
import { openHistorial } from "./cuentas.js?v=105";
import { esc } from "../modal.js?v=105";
import { sentidoDeTransferencia } from "./movimientos.js?v=105";
import { colorTema, paletaTema } from "../tema.js?v=105";
