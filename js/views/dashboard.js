...
import { avisosDeCobro, proximosCobros, textoEnDias, avisosCobroActivos } from "./prestamos.js?v=125";
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=125";
import { seedInitialData } from "../seed.js?v=125";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=125";
import { openHistorial } from "./cuentas.js?v=125";
import { esc, openModal, closeModal } from "../modal.js?v=125";
import { sentidoDeTransferencia } from "./movimientos.js?v=125";
import { colorTema, paletaTema } from "../tema.js?v=125";
