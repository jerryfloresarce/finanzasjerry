...
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=106";
import { seedInitialData } from "../seed.js?v=106";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=106";
import { openHistorial } from "./cuentas.js?v=106";
import { esc } from "../modal.js?v=106";
import { sentidoDeTransferencia } from "./movimientos.js?v=106";
import { colorTema, paletaTema } from "../tema.js?v=106";
