...
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=96";
import { seedInitialData } from "../seed.js?v=96";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=96";
import { openHistorial } from "./cuentas.js?v=96";
import { esc } from "../modal.js?v=96";
import { sentidoDeTransferencia } from "./movimientos.js?v=96";
import { colorTema, paletaTema } from "../tema.js?v=96";
