...
import { abrirReceta } from "./vida-menu.js?v=90";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=90";
import { fechaISO, formatFecha } from "../db.js?v=90";
