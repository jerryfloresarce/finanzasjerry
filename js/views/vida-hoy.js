...
import { abrirReceta, abrirCambioFecha } from "./vida-menu.js?v=119";
import { pedirVista } from "./vida-agenda.js?v=119";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=119";
import { fechaISO, formatFecha } from "../db.js?v=119";
import { localeActual } from "../idioma.js?v=119";
import { efectoDeCelebracion } from "../efectos.js?v=119";
import { openModal, closeModal, esc } from "../modal.js?v=119";
