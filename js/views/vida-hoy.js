...
import { abrirReceta } from "./vida-menu.js?v=89";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=89";
import { fechaISO, formatFecha } from "../db.js?v=89";
