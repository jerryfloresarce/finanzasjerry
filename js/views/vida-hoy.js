...
import { abrirReceta, abrirCambioFecha } from "./vida-menu.js?v=126";
import { pedirVista } from "./vida-agenda.js?v=126";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=126";
import { fechaISO, formatFecha } from "../db.js?v=126";
import { localeActual } from "../idioma.js?v=126";
import { efectoDeCelebracion } from "../efectos.js?v=126";
import { openModal, closeModal, esc } from "../modal.js?v=126";
