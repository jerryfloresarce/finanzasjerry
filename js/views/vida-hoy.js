...
import { abrirReceta } from "./vida-menu.js?v=74";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=74";
import { fechaISO, formatFecha } from "../db.js?v=74";
