...
import { abrirReceta, abrirCambioFecha } from "./vida-menu.js?v=120";
import { pedirVista } from "./vida-agenda.js?v=120";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=120";
import { fechaISO, formatFecha } from "../db.js?v=120";
