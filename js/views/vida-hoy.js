...
import { abrirReceta } from "./vida-menu.js?v=71";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=71";
import { fechaISO, formatFecha } from "../db.js?v=71";
