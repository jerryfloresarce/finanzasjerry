...
import { abrirReceta } from "./vida-menu.js?v=91";
import { necesitaArranqueGaby, arrancarPerfilGaby } from "../vida-arranque-gaby.js?v=91";
import { fechaISO, formatFecha } from "../db.js?v=91";
