...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=65";
import { openModal, closeModal, todayISO } from "../modal.js?v=65";
import { icon } from "../icons.js?v=65";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=65";
