...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=67";
import { openModal, closeModal, todayISO } from "../modal.js?v=67";
import { icon } from "../icons.js?v=67";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=67";
import { wrapSwipe, attachSwipe } from "../swipe.js?v=67";
import { efectoDeCelebracion } from "../efectos.js?v=67";
