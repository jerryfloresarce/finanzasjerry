...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=69";
import { openModal, closeModal, todayISO } from "../modal.js?v=69";
import { icon } from "../icons.js?v=69";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=69";
import { wrapSwipe, attachSwipe } from "../swipe.js?v=69";
import { efectoDeCelebracion } from "../efectos.js?v=69";
