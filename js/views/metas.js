...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=63";
import { openModal, closeModal, todayISO } from "../modal.js?v=63";
import { icon } from "../icons.js?v=63";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=63";
