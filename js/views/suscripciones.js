import { addSuscripcion, updateSuscripcion, deleteSuscripcion, addMovimiento, deleteMovimiento, formatEUR, formatFecha, fromTimestamp, toTimestamp } from "../db.js?v=44";
import { openModal, closeModal, optionsFrom, todayISO } from "../modal.js?v=44";
import { icon, iconForSuscripcion } from "../icons.js?v=44";
