import { addCategoria, updateCategoria, deleteCategoria, gastosPorCategoriaDelMes, formatEUR } from "../db.js?v=83";
import { openModal, closeModal } from "../modal.js?v=83";
import { entityIcon, iconForCategoriaTipo, icon } from "../icons.js?v=83";
import { attachCopyId, copyIdButton } from "../copy-id.js?v=83";
import { emojiFieldHTML, attachEmojiPicker, CATEGORIA_EMOJIS } from "../emoji-picker.js?v=83";
