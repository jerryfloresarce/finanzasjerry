...
import { formatEUR, formatFecha, fromTimestamp } from "../db.js?v=128";
import { t } from "../idioma.js?v=128";
import { openModal, closeModal } from "../modal.js?v=128";
import { colorTema } from "../tema.js?v=128";
import { efectoAlGuardar } from "../efectos.js?v=128";
import { initials, avatarColor } from "../icons.js?v=128";
