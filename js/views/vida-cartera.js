...
import { formatEUR, formatFecha, fromTimestamp } from "../db.js?v=129";
import { t } from "../idioma.js?v=129";
import { openModal, closeModal } from "../modal.js?v=129";
import { colorTema } from "../tema.js?v=129";
import { efectoAlGuardar } from "../efectos.js?v=129";
import { initials, avatarColor } from "../icons.js?v=129";
