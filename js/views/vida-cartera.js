...
import { formatEUR, formatFecha, fromTimestamp } from "../db.js?v=131";
import { t } from "../idioma.js?v=131";
import { openModal, closeModal } from "../modal.js?v=131";
import { colorTema } from "../tema.js?v=131";
import { efectoAlGuardar } from "../efectos.js?v=131";
import { initials, avatarColor } from "../icons.js?v=131";
