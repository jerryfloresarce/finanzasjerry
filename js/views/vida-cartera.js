...
import { formatEUR, formatFecha, fromTimestamp } from "../db.js?v=130";
import { t } from "../idioma.js?v=130";
import { openModal, closeModal } from "../modal.js?v=130";
import { colorTema } from "../tema.js?v=130";
import { efectoAlGuardar } from "../efectos.js?v=130";
import { initials, avatarColor } from "../icons.js?v=130";
