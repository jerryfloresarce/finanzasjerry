import { localeActual, t as tr } from "../idioma.js?v=131";
import {
  movimientosEnRango,
  totalPorTipo,
...
import { countUpTo, iniciarPaseDeRender } from "../animations.js?v=131";
import { icon, entityIcon, iconForCuentaTipo, iconForSuscripcion } from "../icons.js?v=131";
import { openModal, closeModal } from "../modal.js?v=131";
import { colorTema, paletaTema, conAlfa } from "../tema.js?v=131";
