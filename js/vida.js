...
import { fechaISO } from "./db.js?v=112";
import { perfilVisto, esGaby } from "./vida-perfil.js?v=112";
...
const TIPOS_ENTRENO_JERRY = ["fuerza_A", "fuerza_B", "fuerza_C", "core", "piscina", "caminata", "casa"];
