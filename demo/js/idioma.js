...
import { DICCIONARIO_PT, PATRONES_PT } from "./idiomas/pt.js?v=125";
import { DICCIONARIO_EN, PATRONES_EN } from "./idiomas/en.js?v=125";
import { DICCIONARIO_FR, PATRONES_FR } from "./idiomas/fr.js?v=125";
import { DICCIONARIO_IT, PATRONES_IT } from "./idiomas/it.js?v=125";
import { DICCIONARIO_DE, PATRONES_DE } from "./idiomas/de.js?v=125";
import { DICCIONARIO_CA, PATRONES_CA } from "./idiomas/ca.js?v=125";
