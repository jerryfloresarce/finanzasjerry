import { localeActual } from "./idioma.js?v=125";
import {
  collection,
  doc,
  addDoc,
...
export const listenHabitos = (cb) => listen("habitos", null, cb);
export const addHabitos = (data) => addDoc(col("habitos"), data);
export const updateHabitos = (id, data) => updateDoc(doc(db, "habitos", id), data);
export const deleteHabitos = (id) => deleteDoc(doc(db, "habitos", id));

export const listenHabitosHechos = (cb) => listen("habitos_hechos", null, cb);
export const addHabitosHechos = (data) => addDoc(col("habitos_hechos"), data);
export const updateHabitosHechos = (id, data) => updateDoc(doc(db, "habitos_hechos", id), data);
export const deleteHabitosHechos = (id) => deleteDoc(doc(db, "habitos_hechos", id));

// modulo:rutina:fin
// modulo:ciclo:inicio
export const listenCiclos = (cb) => listen("ciclos", null, cb);
export const addCiclos = (data) => addDoc(col("ciclos"), data);
export const updateCiclos = (id, data) => updateDoc(doc(db, "ciclos", id), data);
export const deleteCiclos = (id) => deleteDoc(doc(db, "ciclos", id));

export const listenCicloNotas = (cb) => listen("ciclo_notas", null, cb);
export const addCicloNotas = (data) => addDoc(col("ciclo_notas"), data);
export const updateCicloNotas = (id, data) => updateDoc(doc(db, "ciclo_notas", id), data);
export const deleteCicloNotas = (id) => deleteDoc(doc(db, "ciclo_notas", id));

// modulo:ciclo:fin
// modulo:gimnasio:inicio
export const listenGymSesiones = (cb) => listen("gym_sesiones", null, cb);
export const addGymSesiones = (data) => addDoc(col("gym_sesiones"), data);
export const updateGymSesiones = (id, data) => updateDoc(doc(db, "gym_sesiones", id), data);
export const deleteGymSesiones = (id) => deleteDoc(doc(db, "gym_sesiones", id));

export const listenGymMetas = (cb) => listen("gym_metas", null, cb);
export const addGymMetas = (data) => addDoc(col("gym_metas"), data);
export const updateGymMetas = (id, data) => updateDoc(doc(db, "gym_metas", id), data);
export const deleteGymMetas = (id) => deleteDoc(doc(db, "gym_metas", id));

export const listenGymPesos = (cb) => listen("gym_pesos", null, cb);
export const addGymPesos = (data) => addDoc(col("gym_pesos"), data);
export const updateGymPesos = (id, data) => updateDoc(doc(db, "gym_pesos", id), data);
export const deleteGymPesos = (id) => deleteDoc(doc(db, "gym_pesos", id));

export const listenGymSuplementos = (cb) => listen("gym_suplementos", null, cb);
export const addGymSuplementos = (data) => addDoc(col("gym_suplementos"), data);
export const updateGymSuplementos = (id, data) => updateDoc(doc(db, "gym_suplementos", id), data);
export const deleteGymSuplementos = (id) => deleteDoc(doc(db, "gym_suplementos", id));

export const listenGymTomas = (cb) => listen("gym_tomas", null, cb);
export const addGymTomas = (data) => addDoc(col("gym_tomas"), data);
export const updateGymTomas = (id, data) => updateDoc(doc(db, "gym_tomas", id), data);
export const deleteGymTomas = (id) => deleteDoc(doc(db, "gym_tomas", id));
