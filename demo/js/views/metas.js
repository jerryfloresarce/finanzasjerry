...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=74";
import { openModal, closeModal, todayISO } from "../modal.js?v=74";
import { icon } from "../icons.js?v=74";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=74";
