...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=89";
import { openModal, closeModal, todayISO, esc } from "../modal.js?v=89";
import { icon } from "../icons.js?v=89";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=89";
import { wrapSwipe, attachSwipe } from "../swipe.js?v=89";
import { efectoDeCelebracion } from "../efectos.js?v=89";
