...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=60";
import { openModal, closeModal, todayISO } from "../modal.js?v=60";
import { icon } from "../icons.js?v=60";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=60";
