...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=72";
import { openModal, closeModal, todayISO } from "../modal.js?v=72";
import { icon } from "../icons.js?v=72";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=72";
import { wrapSwipe, attachSwipe } from "../swipe.js?v=72";
import { efectoDeCelebracion } from "../efectos.js?v=72";
