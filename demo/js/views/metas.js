...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=79";
import { openModal, closeModal, todayISO } from "../modal.js?v=79";
import { icon } from "../icons.js?v=79";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=79";
