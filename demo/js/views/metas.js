...
import { addMetaAhorro, updateMetaAhorro, deleteMetaAhorro, formatEUR, formatFecha, fechaISO } from "../db.js?v=64";
import { openModal, closeModal, todayISO } from "../modal.js?v=64";
import { icon } from "../icons.js?v=64";
import { emojiFieldHTML, attachEmojiPicker } from "../emoji-picker.js?v=64";
