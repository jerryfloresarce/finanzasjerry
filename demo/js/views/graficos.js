import { localeActual, t as tr } from "../idioma.js?v=123";
import {
  movimientosEnRango,
  totalPorTipo,
...
import { countUpTo, iniciarPaseDeRender } from "../animations.js?v=123";
import { icon, entityIcon, iconForCuentaTipo, iconForSuscripcion } from "../icons.js?v=123";
import { openModal, closeModal } from "../modal.js?v=123";
import { colorTema, paletaTema, conAlfa } from "../tema.js?v=123";
