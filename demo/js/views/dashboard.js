...
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=97";
import { seedInitialData } from "../seed.js?v=97";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=97";
import { openHistorial } from "./cuentas.js?v=97";
import { esc } from "../modal.js?v=97";
import { sentidoDeTransferencia } from "./movimientos.js?v=97";
import { colorTema, paletaTema } from "../tema.js?v=97";
