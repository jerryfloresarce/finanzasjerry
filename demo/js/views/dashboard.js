...
import { avisosDeCobro, proximosCobros, textoEnDias, avisosCobroActivos } from "./prestamos.js?v=132";
import { initDashboardAnimations, iniciarPaseDeRender, countUpTo, animateProgressBars, estaAsentando } from "../animations.js?v=132";
import { seedInitialData } from "../seed.js?v=132";
import { icon, entityIcon, iconForCategoriaTipo, iconForCuentaTipo, iconForSuscripcion, initials, avatarColor } from "../icons.js?v=132";
import { openHistorial } from "./cuentas.js?v=132";
import { esc, openModal, closeModal } from "../modal.js?v=132";
import { sentidoDeTransferencia } from "./movimientos.js?v=132";
import { colorTema, paletaTema } from "../tema.js?v=132";
