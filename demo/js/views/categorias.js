import { addCategoria, updateCategoria, deleteCategoria, gastosPorCategoriaDelMes, formatEUR } from "../db.js?v=72";
import { openModal, closeModal } from "../modal.js?v=72";
import { entityIcon, iconForCategoriaTipo, icon } from "../icons.js?v=72";
import { attachCopyId, copyIdButton } from "../copy-id.js?v=72";
import { emojiFieldHTML, attachEmojiPicker, CATEGORIA_EMOJIS } from "../emoji-picker.js?v=72";
import { wrapSwipe, attachSwipe } from "../swipe.js?v=72";
