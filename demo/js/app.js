...
import { mountRutina, renderRutina } from "./views/rutina.js?v=90";
// modulo:rutina:fin
// modulo:ciclo:inicio
import { mountCiclo, renderCiclo } from "./views/ciclo.js?v=90";
// modulo:ciclo:fin
// modulo:gimnasio:inicio
import { mountGimnasio, renderGimnasio } from "./views/gimnasio.js?v=90";
// modulo:gimnasio:fin
