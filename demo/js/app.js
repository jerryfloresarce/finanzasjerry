...
import { mountRutina, renderRutina } from "./views/rutina.js?v=100";
// modulo:rutina:fin
// modulo:ciclo:inicio
import { mountCiclo, renderCiclo } from "./views/ciclo.js?v=100";
// modulo:ciclo:fin
// modulo:gimnasio:inicio
import { mountGimnasio, renderGimnasio } from "./views/gimnasio.js?v=100";
// modulo:gimnasio:fin
